...
export declare function buildFullClassPath(dependenciesClassPath: string, outputDirectory: string): string;
export declare function getMvnCommandArgsForMvnExec(targetPath: string): string[];
